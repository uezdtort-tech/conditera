  ...
  return (
    <div className="container mx-auto px-4 py-6 lg:py-10">
      ...
      <MarketplaceCtaCard
        ...
        description="Кафе, банкетные залы, детские клубы и открытые веранды: разместите площадку с фотографиями, прайсом и удобствами. Витрина площадок живёт в разделе «Площадки», бронирование и предоплата — прямо на платформе."
        primaryLabel="Присоединиться и разместить площадку"
        secondaryLabel="Смотреть площадки"
        secondaryView="venues"
